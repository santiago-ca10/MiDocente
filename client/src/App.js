  ...
  const registrarDatos = async (e) => {
    ...
    if (editIndex !== null) {
      ...
      try {
        ...
        alert ('Error de coneccion al actualizar el docente');
      }
...
return (
    <div className="main-container">
      ...
      <div className="form-card">
        ...
        <p className="subtitle">Registro de profesores: datos académicos y de contacto</p>
            ...
            {registros.map((reg, idx) => (
              <tr key={idx}>
                ...
                <td className="actions">
                  <button className="btn-edit" onClick={() => editarRegistro(idx)}>Editar</button>
                  <button className="btn-delete" onClick={() => eliminarRegistro(idx)}>Eliminar</button>
                </td>
              </tr>
            ))}
          </tbody>
